...
namespace Shipit.DER
{
    public partial class AERReportGenerator : Form
    {
        ...
        private void dailyEfficencyReportToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            DataTable dt = rpttran.GetAERData(dtp_from.Value.Date, dtp_to.Value.Date);
            ...
            dataGridView1.Text = "Atraco Efficiency Report";
        ...
        private void printToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            ...
            DataTable temp = dw.ToTable(true, "Atcnum", "Linenum", "Factory_name", "DateOfProd", "TotalQty", "ProducedPercent", "BDqty", "BDDollor", "BDPercent", "Expected100", "BEPercentOB");
            ...
            using (CourierDataDataContext courdatacontext = new CourierDataDataContext(Program.ConnStr))
            {
                ...
                for (int i = 0; i < temp.Rows.Count; i++)
                {
                    ...
                    courdatacontext.AER_TEMPs.InsertOnSubmit(mstr);
        ...
        private void exportToPDFToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
